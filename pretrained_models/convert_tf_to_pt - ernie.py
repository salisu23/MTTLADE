from transformers  import ErnieConfig, ErnieForPreTraining
...
def convert(args):
    ...
    config = ErnieConfig.from_json_file(args.config_file)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--tf-path-model', type=str, default='ernie/params')
    parser.add_argument('--config-file', type=str, default='bert/ernie_config.json')
    parser.add_argument('--model-type', type=str, default='ernie')
    parser.add_argument('--pytorch-file', type=str, default='ernie_model.pt')
